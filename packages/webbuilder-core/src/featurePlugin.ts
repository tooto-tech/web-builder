...
export interface WebBuilderPublisherContribution {
  ...
  ) => WebBuilderPublisherAssets | null | Promise<WebBuilderPublisherAssets | null>
}
...
export type WebBuilderProjectDataHook = (
  context: WebBuilderPluginContext
) => Promise<void> | void

export type WebBuilderActionHook = (
  context: WebBuilderPluginContext
) => Promise<boolean | void> | boolean | void

export type WebBuilderActionSuccessHook = (
