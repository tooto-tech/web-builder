...
type RuleTemplateResourceType = Exclude<TempTemplateResourceType, 'TEMP_LOOP_ITEM' | 'TEMP_POPUP'>

const conditionFieldMap: Record<RuleTemplateResourceType, Array<{
...
const activeFields = computed(() =>
  props.currentTemplateType && props.currentTemplateType in conditionFieldMap
    ? conditionFieldMap[props.currentTemplateType as RuleTemplateResourceType]
    : [],
)
