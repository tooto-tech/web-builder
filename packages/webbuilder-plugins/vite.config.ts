  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        basic: resolve(__dirname, 'src/basic/index.ts'),
        cms: resolve(__dirname, 'src/cms/index.ts'),
        i18n: resolve(__dirname, 'src/i18n/index.ts'),
        'global-settings': resolve(__dirname, 'src/global-settings/index.ts'),
        'layout-template': resolve(__dirname, 'src/layout-template/index.ts'),
        publisher: resolve(__dirname, 'src/publisher/index.ts'),
