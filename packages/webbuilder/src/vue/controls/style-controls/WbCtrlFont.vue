...
const fontControls = useWebBuilderFontControls()
const fontManager = { installedFonts: fontControls.installedFonts }
const allFonts = fontControls.googleFonts
const loading = fontControls.googleFontsLoading
const load = fontControls.loadGoogleFonts
const searchFonts = fontControls.searchGoogleFonts
const injectGoogleFontCss = fontControls.injectGoogleFontCss
...
function selectInstalledFont(font: WebBuilderFontItem) {
