import type { PagePageReqVO, PageResult, PageVO } from '@/api/content/page'
...
type SelectablePageRow = Pick<PageVO, 'resourceKey' | 'resourceName'>
...
const buildSelectablePageQueries = (): Omit<PagePageReqVO, 'pageNo' | 'pageSize'>[] => [
...
export const loadRulePageOptions = async (
  fetchPageList: (params: PagePageReqVO) => Promise<PageResult<SelectablePageRow>>,
