...
const source = readFileSync(
  fileURLToPath(new URL('../../../../../packages/webbuilder-plugins/src/components-cms/cmsFactory.ts', import.meta.url)),
  'utf-8'
)
...
describe('cmsFactory module boundaries', () => {
  ...
  it('loads shared CMS registration helpers without importing concrete post/product registries', async () => {
    await expect(import('../../../../../packages/webbuilder-plugins/src/components-cms/cmsFactory.js')).resolves.toMatchObject({
