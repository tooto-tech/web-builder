...
import { extractGoogleFontLinks } from '../../../../../packages/webbuilder-plugins/src/global-settings/useGoogleFonts.js'
...
describe('global-settings Google Fonts utilities', () => {
  ...
  it('does not hardcode a Google Fonts API key in the package source', () => {
    const source = readFileSync(
      fileURLToPath(new URL('../../../../../packages/webbuilder-plugins/src/global-settings/useGoogleFonts.ts', import.meta.url)),
      'utf-8'
    )
