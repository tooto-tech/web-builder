...
import type {
  ...
  RevisionService,
  RevisionSummary,
} from '../../../../../packages/webbuilder/src/core/hostServices.js'
import type { PageResourceIdentity } from '../../../../../packages/webbuilder/src/core/featurePlugin.js'

describe('hostServices contracts', () => {
  const source = readFileSync(fileURLToPath(new URL('../../../../../packages/webbuilder/src/core/hostServices.ts', import.meta.url)), 'utf8')
